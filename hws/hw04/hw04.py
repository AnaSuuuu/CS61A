...
def has_path(t, phrase):
    ...
    for i in range(1, len(tt)):
        if j < len(phrase) and phrase[j] == tt[i]:
            j += 1
        i += 1
    return j == len(phrase)
...
def quadratic(x, a, b, c):
    ...
    if r <= -b / (2 * a):
        if a > 0:
            return interval(a * l * l + b * l + c, a * r * r + b * r + c)
        else:
            return interval(a * r * r + b * r + c, a * l * l + b * l + c)
    if l >= -b / (2 * a):
        if a > 0:
            return interval(a * l * l + b * l + c, a * r * r + b * r + c)
        else:
            return interval(a * r * r + b * r + c, a * l * l + b * l + c)
    if a > 0:
        return interval((4 * a * c - b * b) / (4 * a), max(a * l * l + b * l + c, a * r * r + b * r + c))
    else:
        return interval(min(a * l * l + b * l + c, a * r * r + b * r + c), (4 * a * c - b * b) / (4 * a))
