...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    previous1, previous0 = 0, 0
    while score0 < goal and score1 < goal:
        if who == 0:
            num_rolls = strategy0(score0, score1)
            get_num = take_turn(num_rolls, score1, dice)
            score0 += get_num
            if feral_hogs and abs(num_rolls - previous0) == 2: score0 += 3
            previous0 = get_num
            ...
            get_num = take_turn(num_rolls, score0, dice)
            score1 += get_num
            if feral_hogs and abs(num_rolls - previous1) == 2: score1 += 3
            previous1 = get_num
